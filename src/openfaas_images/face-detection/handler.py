...
#warm fatbins
flist = s3_client.list_objects(Bucket="hf-dgsf", Prefix="cuda_dumps/onnxrt")['Contents']
...
def handle(req):
    ...
    cmd = "python3 detect.py --mpath ./model/updated_withpreprop_r50.onnx " \
        " --pic_fmt jpg --bsize 16 --gpu --bsize 16 --count 256"
    cmd = cmd.split()
    ...
    #proc_env["AVA_WORKER_DUMP_DIR"] = "/home/ubuntu/serverless-gpus/src/apps/mlperf/cuda_dumps/onnxruntime/"
