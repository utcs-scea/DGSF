...
def setup_run(kmeans_dir, infile, dims, spec):            
    host_dir = "/local_disk/eyoon/serverless-gpus/src/apps/class_kmeans"
    #host_dir = "/home/eyoon/serverless-gpus/src/apps/class_kmeans"
    ...
    var_string = f"""
        AVA_GUEST_DUMP_DIR={guest_dump_dir}
        AVA_WORKER_DUMP_DIR={worker_dump_dir}
    """
