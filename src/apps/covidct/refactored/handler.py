...
SCRIPT_NAME = "main_in_mem_s3.py"
EXTRA_ARGS = "--batch-size 1 --count 2"
DUMPS_PREFIX = "cuda_dumps/covid"
DUMPS_DIR = "/tmp/covid/cuda_dumps"
HOST_AVA_LIBS = "/home/ubuntu/serverless-gpus/build/ava/release/onnx_opt/lib"
WORKER_DUMPS_DIR = "/home/ubuntu/serverless-gpus/src/apps/covidct/cuda_dumps"
REQ_MEMORY = "12000"

#ZOOM_KERNEL_DIR = "/cuda_dumps"
#ZOOM_KERNEL_NAME = "zoom_kernel.cubin"
#os.environ["ZOOM_KERNEL_DIR"] = ZOOM_KERNEL_DIR
os.environ["ZOOM_KERNEL_DIR"] = "/home/ubuntu/serverless-gpus/src/apps/covidct/refactored"
#s3_client.download_file('hf-dgsf', "covid/zoom_kernel.cubin", os.path.join(ZOOM_KERNEL_DIR, ZOOM_KERNEL_NAME))
...
if "RUN_NATIVE" not in os.environ.keys():
    ...
    print("Dumps already exist", file=sys.stderr, flush=True)
...
def handle(req):
    ...
    if "RUN_CPU" in proc_env.keys():
        proc_env["TF_INTRA_OP_PARALLELISM_THREADS"] = "6"
        proc_env["TF_INTER_OP_PARALLELISM_THREADS"] = "6"
